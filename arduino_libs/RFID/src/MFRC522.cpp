...
const __FlashStringHelper *MFRC522::GetStatusCodeName(MFRC522::StatusCode code	///< One of the StatusCode enums.
	...
	switch (code) {
		...
		case STATUS_COLLISION:		return F("2E");
		case STATUS_TIMEOUT:		return F("3E");
		case STATUS_NO_ROOM:		return F("4E");
		case STATUS_INTERNAL_ERROR:	return F("5E");
		case STATUS_INVALID:		return F("6E");
		case STATUS_CRC_WRONG:		return F("7E");
		case STATUS_MIFARE_NACK:	return F("8E");
		default:					return F("E0");
